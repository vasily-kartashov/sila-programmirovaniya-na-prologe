...
Как насчёт массивов? Есть ли в Прологе структура данных для представления коллекций термов, с константным временем доступа &Oscr;_(1)_ к отдельным элементам по индексу?
