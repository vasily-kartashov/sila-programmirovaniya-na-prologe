...
## Програмное рассечение

Рассечение (program slicing) --- это простой и мощный метод, который использует самые общие свойства чистого Пролога для изучения эффектов обобщения и специализации программы.
